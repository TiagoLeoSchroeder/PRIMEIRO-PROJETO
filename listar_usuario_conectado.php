<?php
    ...
    //comando sql.
    $comando = $pdo->prepare("SELECT pk_usuario, nome_usuario, email_usuario,is_adm_usuario, genero_usuario, biotipo_usuario, equipamento_usuario  FROM usuario WHERE pk_usuario=:pk_usuario;");    
