<?php
    ...
    //comando SQL.
    $comando = $pdo -> prepare("INSERT INTO usuario(nome_usuario, email_usuario, senha_usuario, genero_usuario, biotipo_usuario, equipamento_usuario, imagem_usuario, is_adm_usuario) VALUES(:nome,:email,:senha,:genero,:biotipo, :equipamento, :conteudo, 0)");  
