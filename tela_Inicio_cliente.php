    ...
    <header class="cima">
       <p>🏋🏽 LIFT WEIGHTS-HOME 🏋🏽</p> 
        ...
        <div class="dropdown" id="esconder">
            <button><?php include("listar_usuario_imagem.php"); echo '<img height="160px" width="160px" style="position: relative; right: 1.25rem; bottom: 0.6rem; border-radius: 80px" src="' .$informacoes_usuario['imagem_usuario']. '">'; ?></button>
            <div>
